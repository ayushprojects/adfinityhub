      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            We're a team of digital marketing experts passionate about helping businesses thrive in the digital
            landscape through innovative strategies and cutting-edge technology.
          </p>
        </motion.div>
        ...
        <section className="py-16 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300">
              We combine human creativity with artificial intelligence to deliver strategies that are both innovative
              and effective, helping our clients stay ahead in a rapidly evolving digital landscape.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 mb-6">
              To be the leading digital marketing agency that bridges the gap between traditional marketing and advanced
              technology, setting new standards for what's possible in the industry.
            </p>
            <p className="text-gray-300">
              We envision a future where every business, regardless of size, can harness the power of AI and digital
              innovation to achieve extraordinary results and sustainable growth.
            </p>
          </motion.div>
        </section>
        ...
        <section className="py-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">From Start-up to Industry Leader</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">Our growth story and key milestones along the way</p>
          </motion.div>
        ...
        <section className="py-16">
          ...
          >
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Join the hundreds of businesses that have transformed their digital presence with AdfinityHub.
            </p>
