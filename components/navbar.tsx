  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled ? "bg-opacity-90 backdrop-blur-md bg-[#080810] shadow-lg" : "bg-transparent"
      }`}
    >
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              ...
              className={`text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:scale-105"
              }`}
            >
              Home
            </Link>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-[#120820] border border-purple-900/50">
            ...
            <Link
              href="/about"
              className={`text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/about" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:scale-105"
              }`}
            >
              About
            </Link>
            ...
            <Link
              href="/contact"
              className={`text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/contact" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:scale-105"
              }`}
            >
              Contact
            </Link>
          ...
          <div className="container mx-auto px-4 py-4 space-y-4">
            <Link
              ...
              className={`block text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:translate-x-1"
              }`}
            ...
            <div className="space-y-2">
              <div
                className={`text-sm font-medium tracking-wide ${
                  pathname.startsWith("/services") ? "text-primary" : "text-gray-300"
                }`}
              >
                Services
              </div>
            ...
            <Link
              href="/about"
              className={`block text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/about" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:translate-x-1"
              }`}
              onClick={() => setIsOpen(false)}
            >
              About
            ...
            <Link
              href="/contact"
              className={`block text-sm font-medium tracking-wide transition-all duration-300 ${
                pathname === "/contact" ? "text-primary" : "text-gray-300 hover:text-purple-400 hover:translate-x-1"
              }`}
              onClick={() => setIsOpen(false)}
            >
              Contact
